...
execute as @e[tag=log2R] at @s run clone 4 -63 -14 -4 -63 -14 ~ ~1 ~
...
execute as @e[tag=log3L] at @s run clone 4 -63 -14 -4 -63 -14 ~ ~1 ~
...
execute as @e[tag=log4L] at @s run clone 4 -63 -14 -4 -63 -14 ~ ~1 ~
